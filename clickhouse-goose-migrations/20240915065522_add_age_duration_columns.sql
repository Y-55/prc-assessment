...
-- +goose Down
DROP TABLE IF EXISTS "default"."hacker_news_log_mview";
DROP TABLE IF EXISTS "default"."mview_add_hacker_news";
DROP TABLE IF EXISTS "default"."mview_del_hacker_news";
...
ALTER TABLE "default"."hacker_news_log"
DROP COLUMN "before_age",
DROP COLUMN "before_duration",
DROP COLUMN "after_age",
DROP COLUMN "after_duration";
